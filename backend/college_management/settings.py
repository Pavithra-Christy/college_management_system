...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',# Allows unauthenticated users (fix for login issues)
    ],
}
...
CORS_ALLOW_ALL_ORIGINS = True  # Allow all origins (Only use in development)
